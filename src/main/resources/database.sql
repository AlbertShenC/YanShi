...
insert into db_task (id, type, name, requestId, preTaskId, inputEventProperty)VALUES (3, 1,
                                                                                      '解析博客园首页', 3, 2, 'body');

insert into db_task (id, type, name, requestId, preTaskId, inputEventProperty)VALUES (4, 2,
                                                                                      '生成博客园rss', 4, 3, 'body');

insert into db_task (id, type, name, requestId, preTaskId, inputEventProperty) VALUES (5, 3,
                                                                                       '对外暴露rss访问接口', 5, 4, 'body');

create table db_procedure (id int primary key auto_increment, entryTaskId int, lastExecuteDateTime datetime,
                           month int, day int, weekDay int, hour int, minute int, dayInterval int, hourInterval int, minuteInterval int);

insert into db_procedure (id, entryTaskId, lastExecuteDateTime, month, day, weekDay, hour, minute, dayInterval, hourInterval, minuteInterval)
values (1, 2, null, -1, -1, -1, 12, 0, -1, -1, -1);